<template>
  <main>
    ...
    <ListItem v-for="task in list" v-bind:key="task.item.code" v-bind:itemType="task.itemType"
      v-bind:item="task.item" v-bind:status="task.status"></ListItem>
  </main>
</template>
...
export default {
  data() {
      return {
        ...
        {itemType: 'task', item: {name: 'Проект какой-то', code: '2182', author: 'Баранов И.И. создал 7 часов назад', change: 'Неиванов А.А. изменил 8 минут назад'}, status: 'Не активен'},
